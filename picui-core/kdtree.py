        ...
        def addHelper(point, depth, currNode):
            ...
            if (comparisonNumber < point[axis]):
                if (currNode.left != None):
                  ...
                  currNode.left = KDTreeNode(point=point, left=None, right=None)
            else:
                if(currNode.right != None):
                  addHelper(point, depth + 1, currNode.right)
                else:
                  currNode.right = KDTreeNode(point=point, left=None, right=None)
        if(self.root_node != None):
            addHelper(point, 0, self.root_node) 
        else:
